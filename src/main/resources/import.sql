...
insert into user (id, username, email, phone, person_name, person_gender, person_birth_date, cpf, address_street, address_city_id, created_at, updated_at, status) values (1, 'caleb', 'calebisaacdarosa-93@marcati.com', '5579555555555','Caleb Isaac da Rosa', 'MASCULINO', CONVERT('2001-11-02', DATE), '57382624765', 'rua 0', 5, UTC_TIMESTAMP(), UTC_TIMESTAMP(), true);
